...
<!-- Page Header End -->
        ...
        <div class="row g-0">
            <div class="col-lg-3 d-none d-lg-flex">
                <div class="d-flex align-items-center justify-content-center bg-primary w-100 h-100">
                    <h1 class="display-3 text-white m-0" style="transform: rotate(-90deg);">4 Years Experience</h1>
                </div>
            </div>
                ...
                <div class="ms-lg-5 ps-lg-5">
                    ...
                    <div class="owl-carousel service-carousel position-relative wow fadeInUp" data-wow-delay="0.1s">
                        ...
                        <div class="bg-light p-4">
                            ...
                            <h4 class="mb-3">Laundry Service</h4>
                            <p>Stet stet justo dolor sed duo. Ut clita sea sit ipsum diam lorem diam justo.</p>
                            <p class="text-primary fw-medium"><i class="fa fa-check text-success me-2"></i>Quality Service</p>
                            <p class="text-primary fw-medium"><i class="fa fa-check text-success me-2"></i>Customer Satisfaction</p>
                            <p class="text-primary fw-medium"><i class="fa fa-check text-success me-2"></i>Support 24/7</p>
                        ...
                        <div class="bg-light p-4">
                            <div class="d-flex align-items-center justify-content-center border border-5 border-white mb-4" style="width: 75px; height: 75px;">
                                <i class="fa fa-spray-can fa-2x text-primary"></i>
                            </div>
                            <h4 class="mb-3">Stain and Odor Removal</h4>
                            <p>Stet stet justo dolor sed duo. Ut clita sea sit ipsum diam lorem diam justo.</p>
                            <p class="text-primary fw-medium"><i class="fa fa-check text-success me-2"></i>Quality Service</p>
                            <p class="text-primary fw-medium"><i class="fa fa-check text-success me-2"></i>Customer Satisfaction</p>
                            <p class="text-primary fw-medium"><i class="fa fa-check text-success me-2"></i>Support 24/7</p>
                        ...
                        <div class="bg-light p-4">
                            ...
                            <h4 class="mb-3">Ironing and Pressing</h4>
                            <p>Stet stet justo dolor sed duo. Ut clita sea sit ipsum diam lorem diam justo.</p>
                            <p class="text-primary fw-medium"><i class="fa fa-check text-success me-2"></i>Quality Service</p>
                            <p class="text-primary fw-medium"><i class="fa fa-check text-success me-2"></i>Customer Satisfaction</p>
                            <p class="text-primary fw-medium"><i class="fa fa-check text-success me-2"></i>Support 24/7</p>
    ...
    <div class="container-fluid my-5 px-0">
        <div class="video wow fadeInUp" data-wow-delay="0.1s">
            ...
            <h1 class="text-white mb-4">Emergency Carpet Cleaning</h1>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-12 col-sm-6">
                                    <select class="form-select border-0" style="height: 55px;">
                                        ...
                                        <option value="2">Laundry Service</option>
        ...
        <div class="container">
            ...
            <div class="owl-carousel testimonial-carousel position-relative wow fadeInUp" data-wow-delay="0.1s">
                <div class="testimonial-item text-center">
                    ...
                    <img class="bg-light rounded-circle p-2 mx-auto mb-2" src="{{ asset('frontend/assets/img/testimonial-1.jpg') }}" style="width: 80px; height: 80px;">
                    <div class="mb-2">
                ...
                <div class="testimonial-item text-center">
                    ...
                    <img class="bg-light rounded-circle p-2 mx-auto mb-2" src="{{ asset('frontend/assets/img/testimonial-2.jpg') }}" style="width: 80px; height: 80px;">
                    <div class="mb-2">
                        <small class="fa fa-star text-secondary"></small>
                        <small class="fa fa-star text-secondary"></small>
                        <small class="fa fa-star text-secondary"></small>
                ...
                <div class="testimonial-item text-center">
                    ...
                    <img class="bg-light rounded-circle p-2 mx-auto mb-2" src="{{ asset('frontend/assets/img/testimonial-3.jpg') }}" style="width: 80px; height: 80px;">
                    <div class="mb-2">
                        <small class="fa fa-star text-secondary"></small>
                        <small class="fa fa-star text-secondary"></small>
                        <small class="fa fa-star text-secondary"></small>
                ...
                <div class="testimonial-item text-center">
                    ...
                    <img class="bg-light rounded-circle p-2 mx-auto mb-2" src="{{ asset('frontend/assets/img/testimonial-4.jpg') }}" style="width: 80px; height: 80px;">
                    <div class="mb-2">
                        <small class="fa fa-star text-secondary"></small>
                        <small class="fa fa-star text-secondary"></small>
                        <small class="fa fa-star text-secondary"></small>
